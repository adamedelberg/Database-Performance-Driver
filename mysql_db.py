...
def universal_select_without_indexing():
    ...
    sql1 = "SELECT COUNT(*) FROM universal WHERE 'tweets.id' = '995403410492067840';"
    sql2 = "SELECT COUNT(*) FROM universal WHERE 'user.id' = '995403410492067840';"
    ...
    logger.info("{} seconds to select non-indexed".format(run))
...
def universal_insert_one_with_indexing_2():
    ...
    logger.info("{} seconds to universal_insert_one_with_indexing".format(run))
...
def bulk_insert_universal():
    ...
    with document as json_docs:
        for data in json_docs:
            ...
            sql = "INSERT IGNORE INTO universal VALUES (" \
                  "'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}'," \
                  "'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}'," \
                  "'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}'," \
                  "'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}'," \
    ...
    logger.info(" %s seconds to universal_insert %d objects", sql_time, count)
    return sql_time, count


def bulk_insert_universal_indexed():
    delete_from_table("universal_indexed")
    ...
    with document as json_docs:
        for data in json_docs:
            ...
            sql = "INSERT IGNORE INTO universal_indexed VALUES ( " \
                  "'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}'," \
                  "'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}'," \
                  "'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}'," \
                  "'{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}'," \
...
def universal_insert_one_with_indexing():
    delete_from_table('universal_indexed')
    ...
    document = io.open(DOCUMENT_SINGLE, 'r')
    ...
    logger.info(" %s seconds to universal_insert_one_with_indexing %d objects", sql_time, count)
    return sql_time


def universal_insert_one_without_indexing():
    delete_from_table('universal')
    insert()
    ...
    logger.info(" %s seconds to universal_insert_one_without_indexing  %d objects", sql_time, count)
    return sql_time
...
def bulk_insert_normalized():
    ...
    # conn = mysql.connector.connect(user=USER, password=PASS, host=HOST, database=DATABASE, autocommit=False)
    conn = pymysql.connect(user=USER, password=PASS, host=HOST, db=DATABASE, autocommit=False)
    ...
    with document as json_docs:
        for data in json_docs:
            ...
            sql = "INSERT IGNORE INTO tweets VALUES (" \
                  "'{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', " \
                  "'{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', " \
                  "'{}', '{}', '{}', '{}', '{}', '{}', '{}');".format(
                created_at, t_id, t_id_str, text, source, truncated, in_reply_to_status_id, in_reply_to_status_id_str,
            ...
            for hashtag in hashtag_text:
                ...
                sql = "INSERT IGNORE into hashtags (id, hashtag, indices) VALUES ({}, '{}', '{}');".format(
                    id, hashtag_text, indices_text)
            ...
            for url in url_text:
                ...
                sql = "INSERT IGNORE into urls VALUES ({}, '{}', '{}', '{}', '{}');".format(
                    id, url_text, display_url_text, expanded_url_text, indices_text)
            ...
            for symbol in symbol_text:
                ...
                sql = "INSERT IGNORE into symbols VALUES ({}, '{}', '{}');".format(id, symbol_text, indices_text)
            ...
            for user_mention in user_mention_text:
                ...
                sql = "INSERT IGNORE into user_mentions VALUES ({}, '{}','{}','{}','{}','{}');".format(id, name,
                                                                                                       indices,
                                                                                                       screen_name,
                                                                                                       u_id, u_id_str)
            ...
            if 'media' in data['entities']:
                ...
                for media in media_text:
                    ...
                    sql = "INSERT IGNORE into media VALUES ({}, '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}');".format(
                        id, type, sizes, indices, url, media_url, display_url, m_id, m_id_str, expanded_url,
                        media_url_https)
    ...
    conn.close()
    run = time.time() - start
    logger.info(" %s seconds to insert %d objects (normalized)", sql_time, count)
    return sql_time, count
